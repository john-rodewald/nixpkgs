...
- [Zulip](https://zulip.com/), an open-source team chat server. Available as [services.zulip](#opt-services.zulip.enable).
...
- `zulip` now packages the [Zulip server](https://github.com/zulip/zulip) instead of the Zulip desktop client. The desktop client has been renamed to `zulip-desktop`.
